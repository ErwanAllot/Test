...
datas["rentals"].each do |rental|
    ...
    thirty_per_cent_commission = Hash.new
    thirty_per_cent_commission['insurance_fee'] = insurance_fee
    thirty_per_cent_commission['assistance_fee'] = assistance_fee
    thirty_per_cent_commission['drivy_fee'] = drivy_fee

    rental_price_per_car["commission"] = thirty_per_cent_commission
